...
void WorkerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->newLongestPathFound((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<std::vector<int>>>(_a[2]))); break;
        default: ;
        }
        ...
        {
            using _t = void (WorkerThread::*)(int , const std::vector<int> & );
            if (_t _q_method = &WorkerThread::newLongestPathFound; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void WorkerThread::newLongestPathFound(int _t1, const std::vector<int> & _t2)
{
