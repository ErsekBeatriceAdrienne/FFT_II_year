...
#include "../labor_4_2/temperaturesensor.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSTemperatureSensorENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSTemperatureSensorENDCLASS_t qt_meta_stringdata_CLASSTemperatureSensorENDCLASS = {
    {
        QT_MOC_LITERAL(0, 17),  // "TemperatureSensor"
        QT_MOC_LITERAL(18, 19),  // "temperatureExceeded"
        QT_MOC_LITERAL(38, 0)   // ""
    },
    "TemperatureSensor",
    "temperatureExceeded",
...
void TemperatureSensor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->temperatureExceeded((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (TemperatureSensor::*)(int );
            if (_t _q_method = &TemperatureSensor::temperatureExceeded; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TemperatureSensor::temperatureExceeded(int _t1)
{
